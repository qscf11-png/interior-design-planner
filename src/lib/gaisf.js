...
async function editImageNanobanana(imageDataUrl, prompt, apiKey, n = 1) {
  const url = `${GAISF_LOCAL_PROXY}/openai/deployments/nanobanana/images/generations`
...
export async function generateImageDalle(prompt, apiKey, model = 'Dalle3') {
  const url = `${GAISF_LOCAL_PROXY}/openai/deployments/${model}/images/generations?api-version=2024-02-01`
