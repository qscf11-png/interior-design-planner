...
const DESIGN_STYLES = [
  { id: 'scandinavian', name: '北歐極簡', emoji: '🤍', desc: '白灰木質、簡潔線條、自然採光', palette: ['#f5f2ee', '#e8e0d5', '#c4b49a', '#8b7355'], costPerPing: [3, 5], prompt: '北歐極簡風格，白色牆面搭配淺色木質家具，簡約線條，大量自然光，棉麻織品點綴' },
  { id: 'japandi', name: '日式侘寂', emoji: '🍂', desc: '素雅大地色、原木、留白美學', palette: ['#ede8e0', '#c8bfb0', '#9a8e7e', '#6b5f50'], costPerPing: [3, 5], prompt: '日式侘寂風格，大地色系，低矮原木家具，榻榻米元素，紙質燈飾，質樸不完美的美感' },
  { id: 'industrial', name: '現代工業', emoji: '🏭', desc: '水泥灰、金屬管線、粗獷質感', palette: ['#2d2d2d', '#4a4a4a', '#787878', '#d4a853'], costPerPing: [3, 5], prompt: '工業風格，裸露水泥牆面與管線，金屬材質燈具，皮革沙發，深色調搭配暖色燈光' },
  { id: 'luxury', name: '輕奢精品', emoji: '✨', desc: '大理石、黃銅、絲絨質感', palette: ['#1a1520', '#2d2438', '#8b7cf6', '#d4a853'], costPerPing: [6, 10], prompt: '輕奢風格，大理石檯面與地板，黃銅金屬細節，絲絨材質家具，深色牆面配暖色燈帶' },
  { id: 'muji', name: '無印良品', emoji: '🌿', desc: '白橡木、收納整齊、生活感', palette: ['#faf8f5', '#e8dfd4', '#b8a88a', '#7a6b55'], costPerPing: [2.5, 4], prompt: '無印良品風格，白色與淺橡木色為主，開放式收納，簡約實用家具，綠植點綴，溫暖生活感' },
  { id: 'newchinese', name: '新中式', emoji: '🏮', desc: '東方韻味、現代手法、雅致配色', palette: ['#2b1d12', '#6b3a2a', '#c8956c', '#e8d5b8'], costPerPing: [5, 8], prompt: '新中式風格，深色胡桃木家具，中式屏風與水墨畫元素，暖色燈光，現代簡約線條融合東方韻味' },
  { id: 'cream', name: '奶油暖風', emoji: '🧈', desc: '米白奶茶色、柔軟圓弧、療癒', palette: ['#faf5ef', '#efe5d8', '#d4c4ae', '#b8a890'], costPerPing: [3, 5], prompt: '奶油風格，米白與奶茶色系，圓弧造型家具，柔軟布藝，暖色調燈光，溫馨療癒氛圍' },
  { id: 'midcentury', name: '復古摩登', emoji: '🪑', desc: '60年代經典、木腳家具、跳色', palette: ['#f0ebe3', '#c17f59', '#3d6b5e', '#d4a853'], costPerPing: [4, 7], prompt: '中世紀現代風格，經典木腳家具，幾何圖案地毯，跳色抱枕，黃銅與柚木搭配，復古氛圍' },
]
...
function AnalysisResult({ result, image, settings }) {
  ...
  const buildStylePrompt = (style) => {
    ...
    return [
      ...
      `CRITICAL: Keep the EXACT same camera angle, perspective, viewpoint, room shape, walls, ceiling, windows, and doors as the original photo.`,
      `Only change: furniture, decor, wall color/texture, flooring material, lighting fixtures, and soft furnishings.`,
